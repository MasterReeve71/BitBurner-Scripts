...
You should also run 'nodebot.js' (at home, of course). If you want to take some time to build up money and upgrading nodes is taking a lot out of your wallet, just go to srv-nodebot and killall. You can also go back to that server and restart it at a later time.

Go ahead and run 'deploy-servers.js' and 'nodebot-setup.js'. If you don't have enough money to make it happen for these, it'll tell you how much you need... then you just wait until you can afford it and re-run.
...
If you don't have work to do (for a job or for a faction), study at the university to build your hack skill.

As soon as you can afford it, buy a TOR router. This will let you access the darkweb server. Any time you can afford to do so, you should buy a program from there, especially the five programs that open ports: BruteSSH.exe, FTPCrack.exe, relaySMTP.exe, HTTPWorm.exe, and SQLInject.exe.
